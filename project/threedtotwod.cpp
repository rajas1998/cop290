...
// 	G2 = Projectionyz(G_rotated);
// 	G3 = Projectionzx(G_rotated);
// 	// for (int i = 0; i < G_rotated.vertices.size(); ++i)
// 	// {
// 	// 	cout<<G_rotated.vertices[i].one<<" "<<G_rotated.vertices[i].two<<" "<<G_rotated.vertices[i].three<<endl;
// 	// }
// }
